...
plot(data$Date, data$Total_CO2_Emissions, type = "l", col = "black", lwd = 2,
     ylab = "Total CO2 Emissions (million metric tons)",
     xlab = "Date",
     main = "Combined Model Fit",
     cex.lab = 1.2, cex.main = 1.4)

lines(data$Date, y_hat_combined, col = "red", lwd = 2)

legend("topright",
       legend = c("Actual", "LM + ARIMA Fit"),
       col = c("black", "red"),
       lty = 1,
       lwd = 2,
       cex = 1.1,
...
```
```{r}
y_true <- data$Total_CO2_Emissions
y_lm   <- fitted(model1)

plot(data$Date, y_true, type = "l", col = "black", lwd = 2,
     ylab = "Total CO2 Emissions (million metric tons)",
     xlab = "Date",
     main = "Linear Model Fit vs Actual",
     cex.lab = 1.2, cex.main = 1.4)

lines(data$Date, y_lm, col = "red", lwd = 2)

legend("topright",
       legend = c("Actual", "Linear Model Fit"),
       col = c("black", "red"),
       lty = 1,
       lwd = 2,
       cex = 1.1,
